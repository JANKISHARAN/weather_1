...
const WeeklyForecast = () => {
  ...
  return (
    <motion.div
      ...
      className={`${theme.glassBg} ${theme.glassBorder} rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.12)] h-full`}
        ...
        {days.map((day, index) => {
          ...
          return (
            <motion.div
              ...
              className={`flex items-center gap-3 py-3 px-2 rounded-xl hover:bg-white/10 transition-colors cursor-pointer group`}
